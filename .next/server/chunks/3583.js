...
const Nav = /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_15___default().memo(()=>{
    ...
    const goToPage = (type, topicValue, navHeader)=>{
        return type === src_lib_types_backend_modal__WEBPACK_IMPORTED_MODULE_17__/* .NavTypeEnum */ .pE.DOCUMENT ? `${src_lib_utils_routes__WEBPACK_IMPORTED_MODULE_18__/* ["default"] */ .Z.DOCUMENT}?topic=${topicValue}&header=${navHeader}&page=1` : type === src_lib_types_backend_modal__WEBPACK_IMPORTED_MODULE_17__/* .NavTypeEnum */ .pE.COURSE ? `${src_lib_utils_routes__WEBPACK_IMPORTED_MODULE_18__/* ["default"] */ .Z.COURSE}?topic=${topicValue}&header=${navHeader}&page=1` : type === src_lib_types_backend_modal__WEBPACK_IMPORTED_MODULE_17__/* .NavTypeEnum */ .pE.CLASS ? `${src_lib_utils_routes__WEBPACK_IMPORTED_MODULE_18__/* ["default"] */ .Z.CLASS}?topic=${topicValue}&header=${navHeader}&page=1&isClass=true` : type === src_lib_types_backend_modal__WEBPACK_IMPORTED_MODULE_17__/* .NavTypeEnum */ .pE.POST ? `${src_lib_utils_routes__WEBPACK_IMPORTED_MODULE_18__/* ["default"] */ .Z.POST}?topic=${topicValue}&header=${navHeader}&page=1` : type === src_lib_types_backend_modal__WEBPACK_IMPORTED_MODULE_17__/* .NavTypeEnum */ .pE.CHATGPT ? "gpt-search" : "";
    };
