...
/* harmony import */ var src_components_error_message__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(8801);
/* harmony import */ var src_components_input__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(5561);
/* harmony import */ var src_lib_api_user__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(6455);
...
/* harmony import */ var src_lib_utils_validation__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(234);
...
const RegisterForm = ()=>{
    ...
    const [isTickAgree, setIsTickAgree] = react__WEBPACK_IMPORTED_MODULE_5___default().useState(false);
    const [generalError, setGeneralError] = react__WEBPACK_IMPORTED_MODULE_5___default().useState("");
    const [inputphonePosition, setInputphonePosition] = react__WEBPACK_IMPORTED_MODULE_5___default().useState(0);
    ...
    const formik = (0,formik__WEBPACK_IMPORTED_MODULE_1__.useFormik)({
        ...
        onSubmit: async (values)=>{
            ...
            try {
                const user = await src_lib_api_user__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .Z.register(email, password1, password2, full_name);
...
/* harmony import */ var src_components_forms_RegisterForm__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(7976);
