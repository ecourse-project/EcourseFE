...
// import { Class, Course, Document, MoveEnum, RequestStatus } from 'src/lib/types/backend_modal';
...
//   const [currentClassItem, setCurrentClassItem] = useState<Course>(classItem);
