...
// 	}).then(callBack);
// };
// export const AlertProspectError = (
// 	_title: string,
// 	_row: string,
// 	number: number
// ) => {
...
// 					{number} {number > 1 ? 'addresses' : 'address'} could not be imported
// 					due to invalid data. We have imported all other addresses. You can
// 					update your import data & reupload it now, or you can add further
...
// 					{_row}
// 					{number > 5 ? ',..' : null}. If you have further issues, please
