...
const MyDoc = () => {
  ...
  const campaignType = ['Any Type', 'Letters Only', 'Postcards Only', 'Top Agents Only'];
          ...
          >
            ...
            >
              <Input
                ...
                width={32}
              />
              <span>{formik.values.custom_time_delay > 1 ? 'Days' : 'Day'}</span>
            </div>
          </Menu.Item>
        </Menu>
      </div>
  ...
  return (
    <div id="dripItem">
      <Select
        ...
        getPopupContainer={() => document.getElementById('dripItem') as HTMLElement}
